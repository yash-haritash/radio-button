...
function convertFigmaRadioButtonToUnify(figmaJson, overrides = {}) {
  ...
  // Extract colors
  const labelColor = textNode.fills?.[0]?.color || { r: 0.2, g: 0.25, b: 0.33, a: 1 }; // Fallback to #344054
  const descriptionColor = supportingTextNode.fills?.[0]?.color || { r: 0.27, g: 0.33, b: 0.40, a: 1 }; // Fallback to #475467
