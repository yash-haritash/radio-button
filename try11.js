...
function convertFigmaRadioButtonToUnify(figmaJson, overrides = {}) {
  ...
  const radioButtonColor = iconNode?.fills?.[0]?.color || { r: 1, g: 0.8470588326454163, b: 0.8941176533699036, a: 1 }; // #FFD8E4
  ...
  const isDisabled = getPropertyValue(props, "State") === "Disabled" || getPropertyValue(props, "State") !== "Enabled";
